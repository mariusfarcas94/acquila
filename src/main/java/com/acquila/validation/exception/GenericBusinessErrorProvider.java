...
import static com.acquila.validation.exception.GenericBusinessErrorType.BLANK_STRING;
import static com.acquila.validation.exception.GenericBusinessErrorType.EMPTY_COLLECTION;
import static com.acquila.validation.exception.GenericBusinessErrorType.EMPTY_STRING;
import static com.acquila.validation.exception.GenericBusinessErrorType.INPUT_TOO_SHORT;
import static com.acquila.validation.exception.GenericBusinessErrorType.INTERNAL_SERVER_ERROR;
import static com.acquila.validation.exception.GenericBusinessErrorType.INVALID_EMAIL_FORMAT;
import static com.acquila.validation.exception.GenericBusinessErrorType.INVALID_UUID_FORMAT;
import static com.acquila.validation.exception.GenericBusinessErrorType.MIN_VALUE;
import static com.acquila.validation.exception.GenericBusinessErrorType.NOT_FOUND;
import static com.acquila.validation.exception.GenericBusinessErrorType.NULL_FIELD;
import static com.acquila.validation.exception.GenericBusinessErrorType.NULL_PARAMETER;
